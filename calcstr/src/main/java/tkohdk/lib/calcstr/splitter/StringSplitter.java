...
public class StringSplitter implements Splitter {
    ...
    public StringSplitter(){
        ...
        String splitPattern = "(^[-]?[0-9]+[.][0-9]+E[-+]?[0-9]+|^[-]?[0-9]+E[-+]?[0-9]+|^[-][0-9,]+[.]+(?=[*/+-])|^[-][0-9,]*[.]?[0-9]+|^[-][0-9,]+|[0-9]+[.][0-9]+E[-+]?[0-9]+|[0-9]+E[-+]?[0-9]+|(?<=([*/+-]))[-]+[0-9]+[.][0-9]+E[-+]?[0-9]+|(?<=([*/+-]))[-]+[0-9]+E[-+]?[0-9]+|(?<=([*/+-]))[-]+(?:<P>|[0-9,]*[.]?[0-9]+|[0-9,]+)|(?<=\\()[-]+(?:<P>[0-9,]+|[0-9,]*[.]?[0-9]+|[0-9,]+)|[0-9,]+[.]+(?=[*/+-])|[0-9,]*[.]?[0-9]+|[0-9,]+|!|sin|cos|tan|log|[^()0-9, ]+?|\\(|\\))";
